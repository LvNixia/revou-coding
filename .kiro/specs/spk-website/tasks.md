...
- [ ] 1. Setup struktur proyek dan database
...
- [ ] 2. Implementasi autentikasi pengguna
  - [ ] 2.1 Buat halaman login (`public/login.php`)
    - Form login dengan field username dan password
    - Styling responsif menggunakan Tailwind CSS
    - _Requirements: 1.1, 1.2_

  - [ ] 2.2 Buat backend autentikasi (`api/auth.php`)
  ...
  - [ ] 2.3 Buat middleware session guard (`src/middleware/auth_guard.php`)
  ...
  - [ ] 2.4 Implementasi logout (`api/logout.php`)
    - Hapus sesi dan redirect ke halaman login
    - _Requirements: 1.4_

  - [ ] 2.5 Tulis unit test untuk fungsi autentikasi
...
- [ ] 3. Buat layout utama dan navigasi
  - [ ] 3.1 Buat template layout utama (`src/layout/main.php`)
  ...
  - [ ] 3.2 Buat halaman Dashboard (`public/dashboard.php`)
  ...
  - [ ] 3.3 Buat API endpoint dashboard (`api/dashboard.php`)
...
- [ ] 5. Implementasi manajemen kriteria
  - [ ] 5.1 Buat API CRUD kriteria (`api/kriteria.php`)
  ...
  - [ ] 5.2 Buat halaman manajemen kriteria (`public/kriteria.php`)
  ...
  - [ ] 5.3 Implementasi validasi total bobot
  ...
  - [ ] 5.4 Tulis unit test untuk API kriteria
    - Test tambah, update, hapus kriteria
    - Test validasi nama duplikat
    - Test validasi rentang bobot
    - _Requirements: 2.1, 2.2, 2.3, 2.4, 2.7_

- [ ] 6. Implementasi manajemen alternatif
  - [ ] 6.1 Buat API CRUD alternatif (`api/alternatif.php`)
  ...
  - [ ] 6.2 Buat halaman manajemen alternatif (`public/alternatif.php`)
  ...
  - [ ] 6.3 Tulis unit test untuk API alternatif
...
- [ ] 7. Checkpoint — Pastikan semua test lulus
...
- [ ] 8. Implementasi SPK Engine (Algoritma SAW)
  - [ ] 8.1 Buat kelas SPK_Engine (`src/engine/SPKEngine.php`)
  ...
  - [ ] 8.2 Tulis unit test untuk normalisasi SAW
  ...
  - [ ] 8.3 Tulis unit test untuk perhitungan preferensi dan ranking
  ...
  - [ ] 8.4 Buat API endpoint perhitungan (`api/hitung.php`)
...
- [ ] 9. Implementasi tampilan hasil dan laporan
  - [ ] 9.1 Buat halaman hasil perhitungan (`public/hasil.php`)
  ...
  - [ ] 9.2 Implementasi grafik batang dengan Chart.js
    - Integrasikan Chart.js via CDN
    - Render bar chart nilai preferensi setiap alternatif
    - _Requirements: 5.4_

  - [ ] 9.3 Implementasi unduh laporan PDF
  ...
  - [ ] 9.4 Buat halaman riwayat perhitungan (`public/riwayat.php`)
  ...
  - [ ] 9.5 Tulis unit test untuk SPK Engine end-to-end
    - Test alur lengkap: input data → normalisasi → preferensi → ranking
    - Verifikasi hasil ranking konsisten dengan perhitungan manual
    - _Requirements: 4.1, 4.2, 4.3_

- [ ] 10. Checkpoint — Pastikan semua test lulus
  - Pastikan perhitungan SAW menghasilkan hasil yang benar, grafik tampil, dan PDF dapat diunduh. Tanyakan kepada user jika ada pertanyaan.

- [ ] 11. Implementasi keamanan dan validasi input
  - [ ] 11.1 Implementasi CSRF token
  ...
  - [ ] 11.2 Implementasi sanitasi input dan proteksi XSS
  ...
  - [ ] 11.3 Implementasi validasi payload dan rate limiting
  ...
  - [ ] 11.4 Tulis unit test untuk keamanan
...
- [ ] 12. Implementasi pengaturan sistem
  - [ ] 12.1 Buat API pengaturan (`api/pengaturan.php`)
  ...
  - [ ] 12.2 Buat halaman pengaturan (`public/pengaturan.php`)
  ...
  - [ ] 12.3 Implementasi fitur reset data
  ...
  - [ ] 12.4 Tulis unit test untuk pengaturan
...
- [ ] 13. Integrasi dan wiring komponen
  ...
  - [ ] 13.4 Tulis integration test end-to-end
    - Test alur lengkap: login → tambah kriteria → tambah alternatif → hitung SAW → lihat hasil → unduh laporan → logout
